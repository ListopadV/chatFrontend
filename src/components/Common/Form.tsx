...
import {Box, Button, Checkbox, FormControlLabel, MenuItem, SxProps, Theme, styled, TextField} from '@mui/material';
              ...
              <Box sx={{
                ...
                {buttons.map((btn, i) => (
                  <Button
                    ...
                    onClick={btn.type === 'submit' ? undefined : () => btn.onClick?.(values)}
                  >
                    {btn.label}
                  </Button>
                ))}
